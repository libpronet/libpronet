...
cp "${THIS_DIR}/../pub/cfg/pro_service_hub.cfg"              "${THIS_DIR}/linux-x86-d/"
cp "${THIS_DIR}/../pub/cfg/rtp_msg_server.cfg"               "${THIS_DIR}/linux-x86-d/"
cp "${THIS_DIR}/../pub/cfg/rtp_msg_server.db"                "${THIS_DIR}/linux-x86-d/"
cp "${THIS_DIR}/../pub/cfg/rtp_msg_server.sql"               "${THIS_DIR}/linux-x86-d/"
cp "${THIS_DIR}/../pub/cfg/rtp_msg_c2s.cfg"                  "${THIS_DIR}/linux-x86-d/"
cp "${THIS_DIR}/../pub/cfg/test_msg_client.cfg"              "${THIS_DIR}/linux-x86-d/"
cp "${THIS_DIR}/../pub/cfg/test_tcp_server.cfg"              "${THIS_DIR}/linux-x86-d/"
cp "${THIS_DIR}/../pub/cfg/test_tcp_client.cfg"              "${THIS_DIR}/linux-x86-d/"
