...
copy /y %THIS_DIR%..\..\build\windows-vs2013\_debug-md\mbedtls_s-md.lib     %THIS_DIR%windows-vs2013\x86\
copy /y %THIS_DIR%..\..\build\windows-vs2013\_debug-md\mbedtls_s-md.pdb     %THIS_DIR%windows-vs2013\x86\
copy /y %THIS_DIR%..\..\build\windows-vs2013\_debug-md\pro_util_s-md.lib    %THIS_DIR%windows-vs2013\x86\
copy /y %THIS_DIR%..\..\build\windows-vs2013\_debug-md\pro_util_s-md.pdb    %THIS_DIR%windows-vs2013\x86\
...
copy /y %THIS_DIR%..\..\build\windows-vs2013\_debug64x-md\mbedtls_s-md.lib  %THIS_DIR%windows-vs2013\x86_64\
copy /y %THIS_DIR%..\..\build\windows-vs2013\_debug64x-md\mbedtls_s-md.pdb  %THIS_DIR%windows-vs2013\x86_64\
copy /y %THIS_DIR%..\..\build\windows-vs2013\_debug64x-md\pro_util_s-md.lib %THIS_DIR%windows-vs2013\x86_64\
copy /y %THIS_DIR%..\..\build\windows-vs2013\_debug64x-md\pro_util_s-md.pdb %THIS_DIR%windows-vs2013\x86_64\
